...
use Alipay\Lib\AopEncrypt;
use Alipay\Lib\SignData;
use Alipay\Lib\EncryptParseItem;
use Alipay\Lib\Logger;
use Alipay\Lib\Inflector;
use Alipay\Lib\Exception;
...
class Aop {
	...
	protected function logCommunicationError($apiName, $requestUrl, $errorCode, $responseTxt) {
		...
		$logger = new Logger;
		$logger->conf["log_file"] = $this->logdir . '/' . "logs/aop_comm_err_" . $this->appId . "_" . date("Y-m-d") . ".log";
